  ...
  return (
    <>
      <Sidebar collapsed={collapsed} className='h-full bg-[#0E382F] !py-4'>
        <button onClick={()=>setCollapsed(!collapsed)} className='!ms-auto block cursor-pointer'><TfiAngleLeft className='text-white !ms-auto !mb-4 bg-[#EF9B28] h-8 rounded-l-lg'/></button>
